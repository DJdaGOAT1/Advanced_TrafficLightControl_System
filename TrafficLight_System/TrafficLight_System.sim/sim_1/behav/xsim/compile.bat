...
REM
REM Generated by Vivado on Sat Jan 03 19:48:57 -0600 2026
...
echo "xvlog --incr --relax -prj TL_System_Design_TB_vlog.prj"
call xvlog  --incr --relax -prj TL_System_Design_TB_vlog.prj -log xvlog.log
